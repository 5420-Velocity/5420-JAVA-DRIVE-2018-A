...
import org.usfirst.frc.team5420.util.BoundingBox;

/**
 * PixyCam implementation using the I2C interface
 * @link https://github.com/Mercury1089/2018-robot-code/blob/master/robot/src/org/usfirst/frc/team1089/robot/sensors/PixyI2C.java
 * @link https://github.com/Mercury1089/2018-robot-code/blob/64d25c6ad5024f6bb7dce81629c29a2601f39163/robot/src/org/usfirst/frc/team1089/robot/sensors/PixyI2C.java
 */
        ...
        for (int i = 0; i <= 16; i++) {
            ...
            if (syncWord == 0xaa55) { // Check is first 2 bytes equal a "sync word", which indicates the start of a packet of valid data
                ...
                if (checksum != sig + BOXES[sig - 1].getX() + BOXES[sig - 1].getY() + BOXES[sig - 1].getWidth() + BOXES[sig - 1].getHeight()) {
                    BOXES[sig - 1] = null;
                    System.out.println("-- Pixy Error! Invalid Data!");
                }
                break;
            }
        }
